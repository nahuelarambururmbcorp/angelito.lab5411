                ...
                @forelse($photos as $photo)
                    <div class="superbox-list">
                        <table class="dt-table">
                            ...
                            <tr>
                                ...
                                <td style="min-width: 55px;">
                                    <form id="form-delete-row{{ $photo->id }}" method="POST" action="/app/admin/photos/{{ $photo->id }}" class="dt-titan">
                        ...
                        <a href="{{ $photo->url }}" data-lightbox="images" data-title="{{ $photo->name }}">
                            <img src="{{ $photo->url }}" title="{{ $photo->name }}" class="superbox-img">
                        </a>
                    </div>
                @empty
    ...
    <div class="col-xs-12">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <form id="formPhotoDropzone" class="dropzone" method="POST" action="/app/admin/photos/upload" enctype="multipart/form-data">
