                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-toolbar">
                                        <div class="btn-group">
                                            <a href="/app/admin/photos/albums/{{ $item->id }}" class="btn btn-info btn-xs" data-toggle="tooltip" title="Add Photos to {{ $item->name }}">
                                                <i class="fa fa-image"></i>
                                            </a>
                                        </div>
                                        {!! action_row($selectedNavigation->url, $item->id, $item->name, ['edit'], false) !!}
                                    </div>
                                </td>
                            </tr>
                        @endforeach
