    ...
    <main class="Main-Wrapper">
                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="box-detail box-detail-cenaShow text-center">
                            <div class="box-heading mb-5">
                                <h3 class="wow bounceInRight" data-wow-duration="1s" data-wow-delay="0.4s">Cena y
                                    Show</h3>
                            </div>
                            <h3 class="wow bounceInRight" data-wow-duration="1s" data-wow-delay="0.4s"><span
                                        class="font-red">El Espacio</span></h3>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="box-detail  text-center">
                            ...
                            <p class="wow fadeInLeft" data-wow-duration="1s"
                               data-wow-delay="0.3s">{!! $articles->content1 !!}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="show-section-info mt-5">
            <div class="container-lg">
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="box-show wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s"
                             id="show-containerw">
                ...
                <div class="row">
                    <div class="col-12 text-center mb-5">
                        <div class="box-heading">
                            <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s"><span
                                        class="font-red">Programa</span></h3>
                        </div>
                    </div>
                </div>
