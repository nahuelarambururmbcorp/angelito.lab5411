                ...
                <div class="row align-items-end h-100">
                    <div class="col-12 col-lg-12 text-center">
                        <div class="hero-content">
                            <a class="btnReservar cta desplazar wow pulse" data-wow-duration="1s" data-wow-delay="0.5s"
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="box-heading">
                            <h3 class="mb-4 font-gold wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">¿Tras
                                de qué sueños volaron? <br>¿En qué estrella andarán?</h3>
                            <h3 class="mb-4 font-gold wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">Las
                                voces que ayer llegaron <br>y pasaron y callaron.</h3>
                            <h3 class="mb-5 font-gold wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">¿Dónde
                                están? <br>¿Por qué calle volverán?</h3>
                            <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Tango 1944 / Jose
                                Razzano / Cátulo Castillo</p>
                        </div>
                        <div class="box-show-wrapper">
                            <div class="box-show wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                                ...
                                @foreach($eventos as $index => $item)
                                    ...
                                    <!-- Modal Reserva -->
                                    <div class="modal fade" id="modalMenu{{ $item->id }}" tabindex="-1"
                                         aria-labelledby="modalMenuLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header" style="    background: #1e1e1e;">
                                                    <h5 class="modal-title" id="modalMenuLabel" style="color: #ffff;">
                                                        MENU</h5>
                                                    <button type="button" class="btn-close" style="color: #ffff;"
            ...
            <div class="container-lg">
                <div class="row">
                    <div class="col-12 text-center mb-5">
                        <div class="box-heading">
                            <h3><span class="font-red wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Programa</span>
                            </h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="box-programa-line">
                            <div class="box-programa_flex">
                                @foreach($timeline as $time)
                                    <div class="box-programa wow fadeInUp" data-wow-duration="1s"
                                         data-wow-delay="0.5s"> {{ $time->description }}
                                        <br><span> {{ $time->title }} </span></div>
                                @endforeach
                            </div>
                        </div>
                    </div>
