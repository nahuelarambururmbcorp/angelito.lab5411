...
Route::group(['namespace' => 'Website'], function () {
    ...
    Route::get('/cena-y-show', 'HomeController@cena_y_show');
    Route::get('/informacion', 'HomeController@informacion');
    Route::get('/shop', 'HomeController@shop');
    
    Route::get('/contact-us', 'ContactUsController@index');
    Route::get('/conversor', 'ConversorController@index');
    Route::get('/calculadora-ganancias', 'ConversorController@ganancias');
    Route::post('/contact-us/submit', 'ContactUsController@feedback');
    Route::get('/cron/dolar', 'HomeController@cron');
    Route::get('/sitemap.xml', 'SitemapController@index');
    Route::get('/googlenew.xml', 'SitemapController@googleNew');
    Route::get('/obtenerCotizaciones', 'HomeController@obtenerCotizaciones');
    ...
    Route::get('/{articleSlug}', 'BlogController@show');
...
|------------------------------------------
*/
Route::group(['middleware' => ['auth', 'auth.admin'], 'prefix' => 'app/admin', 'namespace' => 'Admin'],
    function () {
        ...
        Route::group(['prefix' => 'blog', 'namespace' => 'Blog'], function () {
            Route::get('/', function () {
                return redirect('/app/admin/blog/articles');
            });
